...
export default class Popup extends Component {
  ...
  render() {
    ...
    const imageUrl = `${rootImageUrl}/${product.category}/${imageFolder}/${
      image || "1.jpg"
    }`
  ...
  addToCart = e => {
    const { actions, product, image, configurationCode, parts, totalPrice } =
      this.props
    actions.add(
      {
        ...product,
        totalPrice,
        parts: parts.filter(part => part.inset),
      },
      {
        image,
        configurationCode,
